...
public class RandomMovement : MonoBehaviour {
    ...
    void Start()
    {
        ...
        {
            Transform t = GameObject.Find("PetBounds").GetComponent<Transform>();
            screenSpace = new Rect(new Vector2(t.position.x - t.localScale.x/2, t.position.y - t.localScale.y / 2), t.localScale);
